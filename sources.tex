...
\clearpage
\begin{figure}
    \includeSource{Cererols/Cererols-CAN-SI1.pdf}
    \caption{%
...
\begin{figure}
    \includeSource{Cererols/Cererols-CAN-Ac-Coplas.pdf}
    \caption{%
        Cererols, \worktitle{Suspended, cielos}, \signature{E-CAN}{AU/0116},
...
\begin{figure}
    \includeSource{Cererols/Cererols-Bbc-SI1.pdf}
    \caption{%
...
\begin{figure}
    \includeSource{Cererols/Cererols-poem-1651-Madrid.pdf}
    \caption{%
...
\begin{figure}
    \includeSource{Padilla-Voces/Padilla-Voces-TI-intro.pdf}
        \caption{%
...
\begin{figure}
        \includeSource{Padilla-Voces/Padilla-Voces-AI-copla.pdf}
        \caption{%
            Gutiérrez de Padilla, \worktitle{Voces, las de la capilla},
...
\begin{figure}
    \includeSource{Caseda/Caseda-S2-estr-end.pdf}
    \caption{%
...
\begin{figure}
    \includeSource{Caseda/Caseda-T-estr-end.pdf}
    \caption{%
        Cáseda, \worktitle{Qué música divina}, 
...
\begin{figure}
    \includeSource{Caseda/Caseda-T-copla-above.pdf}
    \includeSource{Caseda/Caseda-T-copla-under.pdf}
    \caption{
        Cáseda, \worktitle{Qué música divina}, 
...
\begin{figure}
    \includeSource{Padilla-Al_establo/Padilla-Al_establo-SI-1.pdf}
    \caption{%
        Gutiérrez de Padilla, \worktitle{Al establo más dichoso},
        \signature{MEX-Pc}{Leg. 1/3}, Tiple I-1 partbook, with portions of
        \term{Nuevo Troyano}, \term{Arriero}, and \term{Papalotillo}
    }
    \label{Padilla-Establo-1}
\end{figure}

\begin{figure}
    \includeSource{Padilla-Al_establo/Padilla-Al_establo-BI-bajon.pdf}
    \caption{%
        Gutiérrez de Padilla, \worktitle{Al establo más dichoso},
...
\begin{figure}
    \includeSource{Padilla-Al_establo/Padilla-Al_establo-SI-Gloria.pdf}
    \caption{%
        Gutiérrez de Padilla, \worktitle{Al establo más dichoso},
...
\begin{figure}
    \includeSource{Padilla-Al_establo/Padilla-Al_establo-SII-Gloria.pdf}
    \caption{%
        Gutiérrez de Padilla, \worktitle{Al establo más dichoso},
...
\begin{figure}
    \includeSource{Salazar/Salazar-SI.pdf}
    \caption{%
