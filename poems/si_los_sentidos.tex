...
\begin{poemtitle}
\section{\worktitle{Si los sentidos queja forman del Pan Divino} (Zaragoza, 1688)}
...
3. Toca el tacto pero 
  \critnote{yerra}{\variant*{\srcI}{ierra}; \variant*{\srcC}{hierra}; probably variants of \gloss{erra}{errs, misses}.}
 &
