...
\StanzaSection{4}[\add{The Mule Driver}]
    \critnote{Sir Baby,}
    {This former swordsman addresses the
    Christ-child like with formal title and pronouns like a commanding officer,
    but in the same breath begins to swear.}
    \critnote{I swear to Saint Somebody,}
    {A figure of speech, allowing one to swear without quite blaspheming.} &
