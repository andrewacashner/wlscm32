...
y hoy mercader de \critnote{panochas}
  {In Mexican Spanish, slabs of hard brown sugar or candies made from them (RAE); cf. English \mentioned{penuche} (OED).}, \&
...
\critnote{ande en flores y con flores}
  {\foreign{Andar en flores} is an idiom for refusing to get into an argument; \foreign{con flores} could refer to Bartholo's candies or perhaps flowers he sells from his cart.} &
...
\Stanza{1}
Turu turu yega, ayta \critnote{ayta}[Turu turu yega,/ ayta, ayta]
