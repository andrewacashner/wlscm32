...
\poemsource{%
    ...
    \worktitle{Navidad del año de 1652} (\signature{MEX-Pc}{Leg.~1/3})%
}
\end{poemtitleblock}
...
\StanzaSection{4}[\add{Introducción} a 4]
Al establo más dichoso, &
...
arriero \critnote{de cala y gorra}
  {The manuscripts have \foreign{cala} clearly, 
    but the meaning is unclear. 
    Possibly a mistake for 
    \gloss{de capa y gorra}{in plain, simple clothes} (DRAE).} &
...
\critnote{Señor niño, voto a San\dots}
{Bartolo refers to the Christ-child as \quoted{Sir} or \quoted{Lord}, and
...
puesto a \critnote{lo de aquí fue Troya}
  ...
  and referring back to the \quoted{Nuevo Troyano}.} \&
...
\critnote{ande en flores y con flores}
  {\foreign{Andar en flores} is an idiom for refusing to argue; 
  \foreign{con flores}, possibly sweets.} &
...
que \critnote{\term{papalotillo}}
  {Diminutive of \gloss{papalote}{kite or paper toy}, 
  derived from Nahuatl \gloss{papalotl}{butterfly} (RAE).}
   nombran &
...
\critnote{El Angola Minguelillo}
  ...
  \soCalled{nation} or brand, likely a slave.} &
...
Dejando \critnote{el tumbacatumba} 
  ...
  Cf. the refrain of Padilla's 1651 \term{ensaladilla}, 
  \quoted{Tumbucutú, cutú, cutú}.} &
...
\critnote{de su tizón la tizona.}[desenvainó\dots\ de su tizón la tizona]
  ...
  \foreign{Tizona} means sword (after the Cid's weapon), 
  playing on the idea of Minguelillo leading a quasi-military \soCalled{troop} 
  (as in the Black Kings Festivals of New Spain).
  \foreign{Tizón} means a charred log or piece of coal, 
...
\critnote{}[Negrilla]{\gloss{La negrilla}{Little black song} 
...
y la venimo a \critnote{buscá}[Diga plimo\dots\ busca]
  {Possible equivalent in proper Spanish: 
   \quoted{Diga primo, ¿dónde está/ el niño de nacimiento?/ 
   porque sabemos sus parientes/ y lo venimos a buscar}.}. \&

\Stanza{5}
\critnote{Aytá}
  {Written in MS as \foreign{aytá} and \foreign{a\'yta}; 
  probably for \gloss{ahí está}{there he is}, 
  answering the question \foreign{donde sa}.}%
    , aytá, &
cundiro entle pajita &
su ojo como treyita &
y uno buey y uno mulita &
con su baho, \critnote{cayentá.}[aytá\dots\ cayentá]
  {\quoted{Ahí está,/ candela entre pajitas,/ 
  su ojo como estrellita,/ y un buey y una mulilla/ con su bajo callentar}.} \&

\Stanza{2}
Turu turu yega, &
aytá \critnote{aytá}[Turu turu yega,/ aytá, aytá]
  {Possibly, \quoted{Todos, todos llegan,/ ahí está}; 
...
sucuchá, que cantamo lo \critnote{angelito:}[Caya\dots\ lo angelito]
  {Possible equivalent: \quoted{Calla, calla, mira, no le espanta,/ 
  que duerme el chiquitito,/ Jesús, Jesús, qué bonito,/ 
  esuchar, que cantamos a lo del angelito} or \quoted{a lo angélico}.}
\SectionBreak
...
\critnote{Valamindioso que lindo cantá}
...
Y uno \critnote{papagayito}
  {\foreign{Flor de Nochebuena}, poinsettia, 
  native to Central America (DRAE).}%
  , \emph{aytá}. &
Que savemo \critnote{habra}[Caya\dots\ savemo habra]
  {\quoted{Calla, calla, chiquito,/ que traemos un presente,/ 
  una mantilla, un pañalito,/ y un papagayito,/ que sabemos habrá}.}.
\SectionBreak[\add{Repeat estribillo of negrilla}]
...
mantequiya con \critnote{mele}[Mi siñol\dots\ mele]
  {\quoted{Mi señor Manuel/, esa papa, qué sabrosa,/ 
  porque está linda cosa,/ mantequilla con mel}.}%
    , \emph{aytá}. &
...
\critnote{without telling me anything}
  ...
  \quoted{without anything to say}.}%
    , \&
...
Look on him well, though now \critnote{bundled up}
  ...
  in a theological sense, \quoted{confines himself}.}%
    , &
...
for he will be revealed as \critnote{pasture and pastor}
  {\foreign{Pasto}, livestock feed (and allegorically, the Eucharist); 
  \foreign{pastor}, shepherd or religious minister.}. \&
...
for when he is big he will be the \critnote{farm owner}
{\foreign{Labrador}, landowner and employer of farm laborers.}. \&
...
for we know how things go \add{with babies}. \&
