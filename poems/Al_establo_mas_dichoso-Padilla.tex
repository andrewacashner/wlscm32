...
\critnote{ande en flores y con flores}
  {\foreign{Andar en flores} is an idiom for refusing to argue; \foreign{con
  flores}, possibly sweets.} &
...
\critnote{El Angola Minguelillo}
  {Diminutive of Miguel, an African of the Angolan \soCalled{nation} or brand, likely a slave.} &
...
\critnote{Gloria en las alturas y en la tierra paz.}[Gloria\dots]  
  {Here the black characters are joined by two boys, apparently representing the
  angelic chorus.}
