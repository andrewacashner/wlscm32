...
arriero \critnote{de cala y gorra}
  {The manuscripts have \foreign{cala} clearly, but the meaning would be unclear. Possibly a mistake for \gloss{de capa y gorra}{in plain, simple clothes} (DRAE).} &
que fue espadachín de antaño, &
y hoy mercader de \critnote{panochas}
  {In Mexican Spanish, slabs of hard brown sugar or candies made from them (DRAE); cf. English \mentioned{penuche} (OED).}, \&
