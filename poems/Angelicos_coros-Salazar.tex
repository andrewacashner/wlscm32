...
\poemhead{%
    \worktitle{Angélicos coros con gozo cantad} (Puebla, \circa{1680})%
}
\poemsource{%
    Anonymous, from musical setting by Antonio de Salazar, Puebla, Convento de
    la Santísima Trinidad (\signature{MEX-Mcen}{CSG.256})%
}
\end{poemtitleblock}
...
que es \critnote{casa de pan}
  {\term{Bethlehem} means \quoted{House of Bread} in Hebrew; 
