...
\poemhead{%
    \worktitle{Si los sentidos queja forman del Pan Divino} (Zaragoza, 1688)%
}
\poemsource{%
    Vicente Sánchez, \worktitle{Lyra Poética} (Zaragoza, 1688), 171--172;
    Variant versions set by Miguel de Irízar (I) and Jerónimo de Carrión (C) at
    Segovia Cathedral (E-SE: 5/32 and 28/25, respectively)%
}
\end{poemtitleblock}
