...
\poemsource{Vicente Sánchez, \worktitle{Lyra Poética} (Zaragoza, 1688), 171--172; 
...
mas si para \critnote{percibilla}{\sameas percibirla; \variant{\srcI}{a percebilla}[\sameas percibirla: notice, discern, recognize]} &
no llegan rendidos, &
\tagline \&
...
Let the senses not be considered senses. 
\SectionBreak

\def\tagline{\emph{let the senses not be considered senses.}}

\StanzaSection{7}
1. If in the eyes that admire &
cannot see well, &
