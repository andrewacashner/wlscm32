...
Anonymous, from musical setting by Juan Gutiérrez de Padilla, 
  \worktitle{Navidad del año de 1657}, no.~4 (\signature{MEX-Pc}{Leg.~3/3}); see note on sources below
...
A 1649 catalog entry from the collection of Portuguese King John IV appears to indicate an earlier setting of the same or similar text as Padilla's, by Francisco de Santiago, chapelmaster of Seville Cathedral until his death in 1644: \fullcite[caixão 26, no.~674]{JohnIV:Catalog}, \quoted{Vozes las de la capilla. solo. Ya trechos las distancias. a 9}.

Compare the related poem, \worktitle{Cantores de la capilla}, performed at Seville Cathedral, Epiphany 1647, probably in a setting by Santiago's successor Luis Bernardo Jalón: \worktitle{Villancicos que se cantaron en la S.~Iglesia Metropolytana de Sevilla, en los Maytines de los Santos Reyes. En este año de mil y seiscientos y quarenta y siete} (Puebla de los Ángeles, private collection, courtesy of Gustavo Mauleón Rodríguez). 
