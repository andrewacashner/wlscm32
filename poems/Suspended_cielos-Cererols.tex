...
\begin{poemtitle}
\poemhead{\worktitle{Suspended, cielos, vuestro dulce canto} (Montserrat, \circa{1660})}
\poemsource{Anonymous text from setting by Joan Cererols (\signature{E-CAN}{AU/0116}); see critical notes regarding other sources from this villancico tradition}
\end{poemtitle}
