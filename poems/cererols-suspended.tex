...
Anonymous text from setting by Joan Cererols (E-CAN: AU/0116)%
  ...
  In a few passages, indicated below, the text of the coplas in \worktitle{CAN} departs from the consensus of the other poetic imprints from this villancico tradition.}
\end{poemtitle}
...
\critnote{un niño soberano}
  {In place of ll.~11--12, the Eucharistic \worktitle{Bbc} version has \textquote{y desde un pan divino/ un hombre soberano} (and through divine bread, a sovereign man).} &
...
de \critnote{un desentono tan vano}
  {\worktitle{CAN}: Tiple I-1 has \textquote{desatento} (inattentiveness) instead of \textquote{desentono} (untunefulness); both vocal parts have \textquote{tan grande} instead of the metrically correct \textquote{tan vano} in the poetry imprints.}. \&

\Stanza{4}
5. En las pajas \critnote{sustenido}
  {\worktitle{CAN}: Tiple I-1 and 2 have \textquote{susteniendo} (sustaining/sharping); but Altus I and Tenor I have \textquote{sustenido}, in agreement with the poetry imprints.} &
