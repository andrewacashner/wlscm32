...
\poemhead{%
    \worktitle{Qué música divina} (Zaragoza and Puebla, \circa{1700})%
}
\poemsource{%
    Anonymous text from setting by José de Cáseda
    (\signature{MEX-Mcen}{CSG.256}); coplas attrib. Vicente Sánchez,
    \worktitle{Lyra poética} (Zaragoza, 1688), 191%
}
\end{poemtitleblock}
...
en quiebros \critnote{suaves, sonoros y graves}
  {Cf. \worktitle{Voces, las de la capilla} (Gutiérrez de Padilla), 
    \quoted{grave, suave y sonoro}.}%
  , &
acordes accentos &
...
de esa \critnote{divina cítara y humana}
  {The central conceit of the coplas connect Christ, in his Passion, to a string
    instrument.  
    The Spanish \term{vihuela} is linked to an older allegorical
    tradition of the \term{cítara} and the \term{lira}.}%
  , &
...
\critnote{cuantas}
  {Sánchez: \mentioned{quantos}.}
     ellos percibían serían \critnote{falsas}
      {Notes that are out of tune, out of temperament, incorrect, or that use \term{musica ficta} accidentals.}%
        . \&
