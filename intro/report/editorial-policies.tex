...
\end{Footnote}
The exception to this rule is in the \term{negrilla} of Gutiérrez de Padilla's
\term{Al establo más dichoso}, in which it seemed more responsible to present
the pseudo-African dialect in its original orthography.
...
Two pieces, \worktitle{Suspended, cielos} by Joan Cererols, and \worktitle{Qué
música divina} by José de Cáseda, are also provided in transposed editions that
