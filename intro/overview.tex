...
central part of social life.%
  \begin{Footnote}
      ...
      española e hispanoamericana}, and the studies in the bibliography below.
...
The first two pieces, \worktitle{Suspended, cielos, vuestro dulce canto} by the 
Catalan monk Joan Cererols, and \worktitle{Voces, las de la capilla} by Juan 
...
imperfect music and \quoted{listen to the newest consonance} of Christ.
...
that Cererols creates for \term{contrapunto celestial}.
...
Padilla's \term{estribillo} climaxes with an epitome of Incarnational theology, 
\quoted{Everything in man is to ascend, and everything in God is to descend}.
...
Zaragoza composer José de Cáseda's \worktitle{Qué música divina}, intersects 
...
word \quoted{tuneful} in order to represent this \quoted{false} music.
...
collection as the Cáseda piece, in Puebla, the \quoted{city of the angels}.
