...
\begin{Footnote}
    For further introduction to the genre, see the entries for \term{villancico}
    in \worktitle{Grove Music Online} and the \worktitle{Diccionario de la música
...
(\term{autos sacramentales}).

Though many of the sources have been lost, the surviving repertoire is vast and 
rich, encompassing a broad range of devotional life across the Spanish world.
...
Many of the sources specify that the \term{estribillo} was repeated after
the \term{coplas}.
...
\end{Footnote}
The poetry of these \soCalled{metamusical} pieces represents the act 
...
Gutiérrez de Padilla also creates musical devices to illustrate the arcane
music-theoretical and theological references in his poem.
He quotes the plainchant \term{tonus peregrinus} on the words \term{peregrino 
tono}.
The chapelmaster has half his ensemble exhort the other half to \quoted{keep
count with what is sung} while they are literally counting their rests.
...
The \term{estribillo} climaxes with an epitome of Catholic belief about Christ's
Incarnation, \quoted{Everything in man is to ascend, and everything in God is to
descend}.
Gutiérrez de Padilla sets the first line to an ascending line in normal triple
meter and juxtaposes this against the second phrase, which he sets as a long
descending line in \gloss{sesquialtera}{hemiola}, written using all blackened
noteheads.
...
play \worktitle{El nuevo palacio del Retiro} of 1634.%
...
José de Cáseda's setting of \worktitle{Qué música divina} intersects both with
the metamusical conceits of the pieces by Gutiérrez de Padilla and Cererols and
...
\begin{Footnote}
    Powers or faculties of the \gloss{anima sensitiva}{sensitive soul}---
...
Here Gutiérrez de Padilla's ensemble of Spaniards and Spaniard-descended
\term{criollos} presented caricatures of Africans and their music, in a mocking
...
Gutiérrez de Padilla's \quoted{little salad} tosses together characters from
different racial and economic strata to present an idealistic vision of the
whole colonial society united around the body of Christ.
...
\begin{Footnote}
    On Spanish colonial music and musical institutions as reflecting and
