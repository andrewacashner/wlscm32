...
\item (CAN)
\source{\signature{E-CAN}{AU/0116}, Canet de Mar, Arxiu Parròquia de Sant Pere i Sant Pau de Canet, Bisbat de Girona, Fons capella de música; Manuscript performing parts of complete piece with coplas}
...
\item (Bbc)
\source{\signature{E-Bbc}{M/765/24}, Manuscript performing parts, previously unattributed}
\annotation{Villansico a 8}
\parts{SSA, SATB, missing T.~I and Acomp.; estribillo only, no coplas}

\item (MEM)
\source{Modern edition: \fullcite[xxv, 221--236]{Cererols:MEM-VC}, based on \term{CAN}}
