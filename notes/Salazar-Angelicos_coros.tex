...
\begin{notesources}
    ...
    \begin{source}
        ...
        \fullcite[vol. 2, 59--67]{Swadley:VillancicoPhD}}
    \end{source}
...
In the coplas some of the lyrical text is incorrect (\foreign{alcanzar}
instead of \foreign{alcázar}, \foreign{sabe} instead of \foreign{cabe}), 
