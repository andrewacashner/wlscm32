...
\begin{Footnote}
    ...
    hispanoamericana}, and \autocite{Stevenson:CasedaD}.
\end{Footnote}
...
musical \quoted{falsehood} (see copla 5).%
    \Autocite[375--403]{Cashner:PhD}
...
Since the lyric here is \gloss{acorde}{tuneful}, and in light of other such
...
But the Tenor has a sharp on the B in \measure{44}, normally indicating B 
...
\begin{criticalnotes} 
    ...
    56
    & All
    & Tempo \mentioned{a espacio} (more slowly)
