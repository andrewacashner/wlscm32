...
The Bassus I part contains this marking after the \term{Nuevo Troyano} and before the \term{Papalotillo}:
\begin{quote}
\foreign{antes del papalotillo diçe el harriero con el otro bajon}
Before the \term{papalotillo} the mule-skinner speaks [that is, performs his \soCalled{scene}] with the other \term{bajón}
\end{quote}
...
In the midst of the \term{Negrilla}, a caricatured representation of African music-making in pseudo-African dialect Spanish, an \soCalled{Angolan} character (T.~II) sings, \quoted{Listen, for we are singing like the angels}.
...
\includemusic{Padilla-Al_establo-Gloria-urtext}
...
119 & All & Only the T.~I has a fermata here. Given the following text (\quoted{Hush!}) it is possible but speculative that this voice only is meant to hold past the cutoff of the other voices. But it is also common to omit fermatas inadvertently from some of the parts.\\
