...
LyricsIntroTiOne = \LyricsIntroSiOne
...
LyricsCoplasSi = \lyricmode {
  ...
  dió oc -- ta -- va~a -- rri -- ba~en un tri -- no,~en un tri -- no.
}
...
LyricsCoplasAi = \lyricmode {
  ...
  to -- no~al hom -- bre~|y su -- bió tan -- to
  que~en sus -- te -- ni -- dos de llan -- to,
  dió oc -- ta -- va~a -- rri -- ba~en un tri -- no, en un tri -- _ no.
}
...
LyricsCoplasTii = \lyricmode {
  ...
  com -- po -- si -- ción en que prue -- be
  de~un hom -- bre~|y Dios con -- so -- nan -- cias, 
    con -- so -- nan -- cias, con -- so -- nan -- cias.
}
