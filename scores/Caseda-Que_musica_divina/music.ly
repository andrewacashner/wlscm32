...
MusicEstribilloSi = {
  ...
  %% m. 38
  \tempo \markup { \italic "a espacio" [more slowly] }
  R\breve.*2
...
MusicEstribilloA = {
  ...
  r2 bes'2 a'4( bes'4 a'4 bes'4) g'4( bes'4) a'4( g'4)
  fis'2 g'2 r2 r1.
  r2 e''2\fl d''4( e''4 d''4 e''4) c''4( e''4) d''4( c''4)
  %% m. 25
  bes'2\na c''2 r2 r1.
  ...
  %% m. 38
  R\breve.
  r2 r2 a'2 bes'2\flQ bes'2 bes'2
  %% m. 40
  bes'1.\na c''2 c''2 c''2
  r2 bes'2 bes'2 r2 a'1\colorOne
  r2 g'1\colorOne r1.
...
MusicEstribilloT = {
  ...
  %% m. 15
  d'4 d'4 r4 r8 g8 
  d'8 d'8 d'8 g'8 d'8 d'8 d'8 g'8
  d'4 g'8 c'4 g'8 d'4
  \time 3/2
  g1 r2
...
MusicEstribilloB = {
  ...
  << 
    { d2 g2 d1 g2 c2 }
    \figures { < _ >\breve < 6 >1 } %% XX should be 6[-]
  >>
  d2 g2 fis1 g2 
...
MusicCoplaIIIA = {
  \Section "COPLA 3"
  r2 r4\MarkThisUp \markup \italic "[Solo]" d''4
  ...
  a'8 bes'8 c''8 d''8 fis'2
  g'2 r4 g'4 f'8 g'8 \EdBracL e'8 f'8 \EdBracR d'8 es'8 f'8 g'8
...
MusicCoplaVT = {
  ...
  g'4 f'8. f'16 \EdBracR es'8. es'16 d'8 d'8
  c'2 bes2
  r4 d'4 \EdBracL g'2 
...
MusicCoplasSi = {
  \pageBreak
  \DoubleMark { \Section "COPLAS a 4 y solo" } { \MeterChangeCZtoC }
  \time 2/2
