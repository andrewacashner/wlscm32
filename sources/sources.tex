...
\footnotetext{%
    ...
    The original sources are in the public domain, and the images have
    been cropped and edited so that they can be presented in an
    interpretive context, in a scholarly edition whose license
    proscribes commercial use.%
}
